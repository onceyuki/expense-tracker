...
import { PAYMENT_METHODS } from '../utils/format.js';
...
<template>
  <div class="grid grid-cols-1 gap-3 rounded-xl bg-slate-50 p-4 dark:bg-slate-800/40 sm:grid-cols-2 lg:grid-cols-3">
    <BaseSelect v-model="props.filters.category" label="Category" :options="categories.names" placeholder="All categories" />
